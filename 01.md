...
# 01/18
- 구름IDE를 통해, 버전충돌을 방짛면서 서비스 개발

---

# 01/19
- 조코딩의 동물상 테스트를 일본형으로 바꾸기
- 동물상이 아닌, 일본에서 얼굴의 형태를 평가할 때, 하는 간장, 소금, 소스, 등등으로 대체

---

# 01/20
- 일본의 대표적 시오얼굴, 쇼유얼술, 소스얼굴 등등을 beautifulsoup를 통해 이미지 crawling
- 머신러닝으로 인공지능 이미지를 학습
